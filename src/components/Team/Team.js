                ...
                <div className="row text-center">
                    ...
                    <div className="col-xl-3 col-sm-6 mb-5">
                        <div className="bg-white rounded shadow-sm py-5 px-4 border">
                            <img src={process.env.PUBLIC_URL + "/assets/Team/mubashir.jpg"} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                    ...
                    <div className="col-xl-3 col-sm-6 mb-5" >
                        <div className="bg-white rounded shadow-sm py-5 px-4 border">
                            <img src={process.env.PUBLIC_URL + "/assets/Team/hamza.jpg"} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                    ...
                    <div className="col-xl-3 col-sm-6 mb-5">
                        <div className="bg-white rounded shadow-sm py-5 px-4 border">
                            <img src={process.env.PUBLIC_URL + "/assets/Team/waqar.jpg"} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                    ...
                    <div className="col-xl-3 col-sm-6 mb-5">
                        <div className="bg-white rounded shadow-sm py-5 px-4 border">
                            <img src={process.env.PUBLIC_URL + "/assets/Team/amir.jpg"} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
                    ...
                    <div className="col-xl-3 col-sm-6 mb-5">
                        <div className="bg-white rounded shadow-sm py-5 px-4 border">
                            <img src={process.env.PUBLIC_URL + "/assets/Team/saim.jpg"} alt="" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
